        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    FactoryId = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DomainTypes_DomainCategories_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccountPassword = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false),
                    OsType = table.Column<int>(type: "integer", nullable: false),
                    ProjectId = table.Column<int>(type: "integer", nullable: false),
                    ServerIp = table.Column<string>(type: "character varying(45)", maxLength: 45, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Accounts_DomainTypes_OsType",
                        column: x => x.OsType,
                        principalTable: "DomainTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AccountActionRecords_Accounts_AccountId",
                        column: x => x.AccountId,
                        principalTable: "Accounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AccountActionRecords_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccountActionRecords_AccountId",
                table: "AccountActionRecords",
                column: "AccountId");

            migrationBuilder.CreateIndex(
                name: "IX_AccountActionRecords_UserId",
                table: "AccountActionRecords",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_Accounts_OsType",
                table: "Accounts",
                column: "OsType");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DomainTypes_CategoryId",
                table: "DomainTypes",
                column: "CategoryId");
